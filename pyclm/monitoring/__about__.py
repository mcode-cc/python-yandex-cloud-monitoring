...
__title__ = "python-yandex-cloud-monitoring"
__summary__ = "Python Client for Yandex Cloud Monitoring"
__uri__ = "https://github.com/mcode-cc/python-yandex-cloud-monitoring"
__version__ = "0.0.4"
